...
export default function ReferencePage() {
  ...
  const referenceTasks = useMemo(() => {
    return tasks.filter(task => task.stage === 'Reference');
  }, [tasks]);
    ...
    <div className="flex flex-col min-h-screen">
      <main className="flex-grow container mx-auto p-4 md:p-6 lg:p-8">
        <header className="mb-8 text-center">
          <h1 className="text-4xl font-headline font-bold text-primary">Reference</h1>
          <p className="text-muted-foreground mt-2">Items for future reference.</p>
